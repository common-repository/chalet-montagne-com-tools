				...
				<div class="float-left">
					...
					<form name="chalet-montagne-conf" id="chalet-montagne-conf" action="<?php echo esc_url( ChaletMontagneAdmin::get_page_url() ); ?>" method="POST">
						...
						<p>
							...
							<input size="25" id="loueur" class="" name="key" placeholder="<?php esc_html_e( 'Entrez le numéro de loueur' , 'chalet-montagne');?>" type="text">
						</p>
						<p>
							<label for="hash">Clé secrète</label>
							<input size="25" id="hash" class="" name="hash" placeholder="<?php esc_html_e( 'Entrez votre clé secrète' , 'chalet-montagne');?>" type="text">
						</p>
						<p>
